...
<main class="app-layout">
  ...
  <aside class="sidebar-right">
    ...
    <div class="app-footer">
      Made with ❤️ for Swinburne — COS30002 Artificial Intelligence for Games — By E. Ketterer<br />
      ...
      <a class="app-version" href="https://github.com/Arziel1992/cos30002-steering/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer" style="font-family: 'JetBrains Mono', monospace; font-size: 0.6rem; opacity: 0.55; margin-left: 0.4rem; color: inherit; text-decoration: none;" title="Changelog">v{version}</a>
    </div>
  </aside>
  {/if}
